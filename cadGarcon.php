...
<div id="boxcadProdutos">
   ...
   <strong> Nome:</strong> <input name="nomeGarcon" type="text" id="nome"style="font-size: 22px; height: 25px" size="40px"><br/><br/>
    <strong>Login:</strong> <input name="login" type="text" style="font-size: 22px; height: 25px" size="20px" /><br/><br/>	<strong> Senha: </strong> <input name="senha" type="password" style="font-size: 22px; height: 25px" size="19px" /><br/><br/>
    
    <strong>Nível de acesso:</strong><br/>
    <input name="nv" type="radio" value="0" />Administrador <br/>	<input name="nv" type="radio" value="1" />Garçom <br/>	<input name="nv" type="radio" value="2" />Cozinha<br/><br/>
